...
public class Netflix implements StreamingService {
    ...
    private void checkForRegistration(Account user) {
    ...
    private void checkForContentAvailability(String videoContentName) {
    ...
    private void compare(PgRating rating, int age) throws ContentUnavailableException {
    ...
    private void checkForAgeRestriction(Account user, String videoContentName) throws ContentUnavailableException {
